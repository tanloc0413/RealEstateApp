...
public class PostAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.areaSizeUnitAct.setDropDownHeight(500);
        ...
        binding.propertyCategoryTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                Log.d(TAG, "onTabSelected: Loại nhà đất: " + category);
    ...
    private ActivityResultLauncher<Intent> locationPickerActivityResultLauncher = registerForActivityResult(
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    Log.d(TAG, "onActivityResult: Kết quả: " + result);
    ...
    private void validateData() {
        ...
        if (subcategory.isEmpty()) {
            ...
            binding.propertySubcategoryAct.setError("Chọn loại bất động sản");
            ...
            binding.floorsEt.setError("Nhập số tầng...!");
            ...
            binding.bedRoomEt.setError("Nhập số phòng...!");
            ...
            binding.bathRoomEt.setError("Nhập số phòng ắm...!");
            ...
            binding.areaSizeEt.setError("Nhập diện tích...!");
            ...
            binding.titleEt.setError("Nhập tiêu đề...!");
    ...
    private void propertyCategoryHomes() {
        ...
        binding.propertySubcategoryAct.setDropDownHeight(600);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        // cancelled
                        MyUtils.toast(PostAddActivity.this, "Đã hủy!");
                    }
                }
            }
    );
