...
import com.fit.realestate.databinding.ActivityChangePasswordBinding;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if (currentPassword.isEmpty()) {
            ...
            binding.confirmNewPasswordEt.setError("Nhập lại mật khẩu!");
            binding.confirmNewPasswordEt.requestFocus();
        } else if (!newPassword.equals(confirmNewPassword)) {
            /* password in newPasswordEt & confirmNewPasswordEt doesn't match,
               show error in confirmNewPasswordEt */
            binding.confirmNewPasswordEt.setError("Mật khẩu không khớp!");
            binding.confirmNewPasswordEt.requestFocus();
        } else {
        ...
        firebaseUser.reauthenticate(authCredential)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Log.d(TAG, "onSuccess: Xác thực thành công");
                        updatePassword();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        MyUtils.toast(ChangePasswordActivity.this, "Không xác thực được do " + e.getMessage());
                    }
                });
    }
        ...
        firebaseUser.updatePassword(newPassword)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Log.d(TAG, "onSuccess: Đã cập nhật mật khẩu");
                        progressDialog.dismiss();

                        // Clean input
                        binding.currentPasswordEt.setText("");
                        binding.newPasswordEt.setText("");
                        binding.confirmNewPasswordEt.setText("");

                        // Bỏ focus khỏi các ô nhập
                        binding.currentPasswordEt.clearFocus();
                        binding.newPasswordEt.clearFocus();
                        binding.confirmNewPasswordEt.clearFocus();

                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                MyUtils.toast(ChangePasswordActivity.this, "Cập nhật mật khẩu thành công!");
                            }
                        }, 2000);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.e(TAG, "onFailure: ", e);
                        progressDialog.dismiss();
                        MyUtils.toast(ChangePasswordActivity.this, "Không cập nhật được do " + e.getMessage());
                    }
                });
    }
}