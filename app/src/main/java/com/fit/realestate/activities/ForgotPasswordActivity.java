...
import com.fit.realestate.databinding.ActivityForgotPasswordBinding;
...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    private void sendPasswordRecoveryInstruction() {
        ...
        // show progress
        progressDialog.setMessage("Đang gửi link lấy lại mật khẩu!");
        progressDialog.show();
        ...
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Log.d(TAG, "onSuccess: Link đổi mật khẩu đã được gửi");
                        progressDialog.dismiss();
                        MyUtils.toast(ForgotPasswordActivity.this, "Link đổi lại mật khẩu đã được gửi đến " + email);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        MyUtils.toast(ForgotPasswordActivity.this, "Không gửi được do " + e.getMessage());
                    }
                });
    }
}